...
ALTER TABLE [dbo].[Insurances] DROP CONSTRAINT [DF_Insurances_LastUpdateDate]
GO

ALTER TABLE [dbo].[Insurances] DROP CONSTRAINT [DF_Insurances_CreationDate]
GO

ALTER TABLE [dbo].[Insurances] DROP CONSTRAINT [DF_Insurances_UpdatedBy]
GO

ALTER TABLE [dbo].[Insurances] DROP CONSTRAINT [DF_Insurances_CreatedBy]
GO

/****** Object:  Table [dbo].[Insurances]    Script Date: 12/18/2020 9:22:53 PM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Insurances]') AND type in (N'U'))
...
ALTER TABLE [dbo].[Insurances] ADD  CONSTRAINT [DF_Insurances_CreatedBy]  DEFAULT ('Anonymous') FOR [CreatedBy]
GO

ALTER TABLE [dbo].[Insurances] ADD  CONSTRAINT [DF_Insurances_UpdatedBy]  DEFAULT ('Anonymous') FOR [UpdatedBy]
GO

ALTER TABLE [dbo].[Insurances] ADD  CONSTRAINT [DF_Insurances_CreationDate]  DEFAULT (getdate()) FOR [CreationDate]
GO

ALTER TABLE [dbo].[Insurances] ADD  CONSTRAINT [DF_Insurances_LastUpdateDate]  DEFAULT (getdate()) FOR [LastUpdateDate]
GO
